package INHA_super_challenge_hackathon_HitechsFuture.domain.self_diagnosis;

import INHA_super_challenge_hackathon_HitechsFuture.web.member.Member;
import INHA_super_challenge_hackathon_HitechsFuture.web.self_diagnosis.AllDiagnosisFormRepository;
import INHA_super_challenge_hackathon_HitechsFuture.web.self_diagnosis.MemoryPersonalDiagnosisFormRepository;
import INHA_super_challenge_hackathon_HitechsFuture.web.self_diagnosis.PersonalDiagnoseFormRepository;
import INHA_super_challenge_hackathon_HitechsFuture.web.self_diagnosis.SelfDiagnoseForm;
